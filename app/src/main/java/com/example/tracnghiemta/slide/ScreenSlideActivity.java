...
public class ScreenSlideActivity extends FragmentActivity implements ViewScreen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenterScreen = new PresenterScreen();
        ...
        tvKiemtra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                presenterScreen.checkAnswer(arr_Ques, gvLsQuestion, mPager, timer);
            }
        });
...
//    }
    ...
    @Override
    public void oncheckAnswertc() {
        Toast.makeText(this, "thanhcong", Toast.LENGTH_LONG).show();
    }
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            presenterScreen.result(mPager,checkAns,tvKiemtra,tvTimer,tvXemDiem);
        }
    }
}
